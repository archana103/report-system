<template>
   <section class="custom-research-cta section-shell" >
    <div class="cta-inner" :style="{ backgroundImage: 'url(' + $assetUrl + '/assets/images/background-image/reportpage_cta.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }">
      ...
      <div class="cta-content">
        ...
        <router-link to="/contact-us" class="primary-button cta-btn">
          Request Research
