    ...
    <main class="about-main">
      ...
      <section class="about-methodology section-shell">
        ...
        <div class="methodology-waterfall">
          ...
          <div class="waterfall-step step-left">
            <div class="step-icon-wrapper">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="18 20 18 10 12 14 6 10 6 20"></polyline><polyline points="2 22 22 22"></polyline><polyline points="12 4 12 14"></polyline></svg>
            </div>
            <div class="step-copy">
        ...
        <div>
            <div class="section-heading row-heading">
              ...
              <div class="slider-controls">
                <button aria-label="Previous" onclick="document.getElementById('about-insights-grid').scrollBy({left: -350, behavior: 'smooth'})">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15 18l-6-6 6-6"></path></svg>
                </button>
                <button class="active" aria-label="Next" onclick="document.getElementById('about-insights-grid').scrollBy({left: 350, behavior: 'smooth'})">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 18l6-6-6-6"></path></svg>
                </button>
              </div>
            </div>
            <div class="insight-strip" id="about-insights-grid" style="display: flex; overflow-x: auto; scroll-snap-type: x mandatory; scrollbar-width: none;">
