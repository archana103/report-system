                ...
                <tr class="border-b border-gray-700/50 last:border-0 hover:bg-[#1B2230]/50 transition-colors bg-[#151B26]">
                    ...
                    <td class="px-5 py-4 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="{{ route('admin.press_releases.edit', $pr->id) }}" class="flex items-center justify-center w-8 h-8 rounded bg-[#1f2937] hover:bg-[#2d3748] text-sky-400 transition-colors border border-gray-700/50" title="Edit">
                            ...
                            <button type="button" class="flex items-center justify-center w-8 h-8 rounded bg-[#4c1d1a]/50 hover:bg-[#4c1d1a] text-rose-400 transition-colors border border-rose-900/30" title="Delete" onclick="openDeleteModal('{{ $pr->id }}', '{{ addslashes($pr->title) }}')">
