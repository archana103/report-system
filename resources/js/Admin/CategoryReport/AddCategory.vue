  ...
  <div class="animate-in fade-in duration-300">
    ...
    <form @submit.prevent="submitForm" class="space-y-6">
      ...
      <div class="pt-4 border-t border-gray-700/50">
        <!-- Status Message -->
        <div v-if="successMessage" class="mb-6 p-4 rounded-xl text-sm font-medium inline-block w-full" :class="successMessage.includes('successfully') ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-red-500/10 text-red-400 border border-red-500/20'">
           {{ successMessage }}
        </div>
