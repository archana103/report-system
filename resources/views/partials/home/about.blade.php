  ...
  <div class="about-stats">
    <div>
      <span class="icon-span">
        <img src="/assets/images/about_icons/icon1.png" alt="Stat Icon" class="stat-img-icon" />
      </span>
      <strong>500+</strong>
    ...
    <div>
      <span class="icon-span">
        <img src="/assets/images/about_icons/icon3.png" alt="Stat Icon" class="stat-img-icon" />
      </span>
      <strong>100+</strong>
      <p>Global Clients</p>
    </div>
    <div>
      <span class="icon-span">
        <img src="/assets/images/about_icons/icon2.png" alt="Stat Icon" class="stat-img-icon" />
      </span>
      <strong>20+</strong>
