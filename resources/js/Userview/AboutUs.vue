  ...
  <div class="about-page">
    ...
    <main class="about-main">
      ...
      <section class="about-hero"
        :style="{ backgroundImage: 'url(' + $assetUrl + '/assets/images/background-image/aboutpage_banner.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }">
        <div class="about-hero-content section-shell">
          ...
          <p>
            We deliver reliable market research, industry analysis, and data-driven insights that help businesses identify opportunities, understand market trends, and achieve strategic growth.
          </p>
      ...
      <section id="who-we-are" class="about-who-we-are section-shell">
        ...
        <div class="why-choose-image-container">
          <img class="who-image" :src="$assetUrl + '/assets/images/business_model_infographic.gif'"
      ...
      <section class="about-mission-vision section-shell">
        ...
        <div class="mission-section">
          <div class="why-choose-image-container">
            <img class="mission-image" :src="$assetUrl + '/assets/images/client_value_journey_animation.gif'"
        ...
        <div class="mission-commitments-container">
          ...
          <div class="commitments-grid">
            ...
            <div class="commitment-card">
              ...
              <p>Market windows open and close fast. Our streamlined operations and pre-built industry data
                infrastructure mean you receive high-quality intelligence on timelines calibrated to your decision
                cycles not ours.</p>
            </div>
            <div class="commitment-card">
        ...
        <div class="vision-section">
          ...
          <div class="why-choose-image-container">
            <img class="vision-image" :src="$assetUrl + '/assets/images/growth_horizon_animation.gif'"
      ...
      <section class="about-why-choose section-shell">
        ...
        <div class="why-choose-grid">
          <div class="why-choose-card">
            ...
            <p>Every finding is built on verified data, multi-source validation, and rigorous analysis you can act on
              with confidence.</p>
          </div>

          <div class="why-choose-image-container">
            <img class="performance-image" :src="$assetUrl + '/assets/images/performance_metrics_animation.gif'"
              alt="Performance Metrics Chart" />
          </div>

          <div class="why-choose-card">
            <h4>Global Market<br>Coverage</h4>
            <p>Research spanning 20+ industries and 50+ countries gives you a clear view of regional, global, and
              emerging markets.</p>
          </div>
        ...
        <div class="section-shell cta-container">
          ...
          <div class="cta-right">
            <div class="industry-card"
              :style="{ backgroundImage: 'url(' + $assetUrl + '/assets/images/background-image/aboutus_ctaaboveimage.png)', backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', minHeight: '380px' }">
            </div>
          </div>
        </div>
      </section>
...
<style src="./aboutStyle.css"></style>
