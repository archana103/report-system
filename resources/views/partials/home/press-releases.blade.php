<section class="content-row-section">
  ...
  <div class="center-action">
    <a href="/press-releases" class="primary-button small">
       Read More 
       <svg viewBox="0 0 512 512" class="small-icon" style="fill: currentColor; stroke: none; width: 18px; height: 18px;" aria-hidden="true">
