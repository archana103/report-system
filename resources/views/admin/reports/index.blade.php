                ...
                <tr class="border-b border-gray-800 last:border-0 hover:bg-gray-800/20 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end gap-4">
                            <a href="{{ route('admin.reports.edit', $report->id) }}" class="text-indigo-400 hover:text-indigo-300 transition-colors" title="Edit">
                            ...
                            <button type="button" class="text-rose-400 hover:text-rose-300 transition-colors" title="Delete" onclick="openDeleteModal('{{ $report->id }}', '{{ addslashes($report->name) }}')">
