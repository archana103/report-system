...
@section('header_title', 'Add Report Category')
    ...
    <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input name="main_heading" type="text" value="{{ old('main_heading') }}" class="w-full bg-gray-800/80 border border-gray-700 rounded-xl px-4 py-2.5 text-sm text-gray-200 focus:outline-none focus:ring-2 focus:ring-teal-500/50 focus:border-teal-500/50 transition-all" />
            </div>
        ...
        <div>
            ...
            <div class="rounded-xl overflow-hidden shadow-sm border border-gray-700 bg-gray-800/50 transition-all">
                <textarea name="main_subheading" class="w-full bg-transparent p-4 text-white focus:outline-none min-h-[160px]">{{ old('main_subheading') }}</textarea>
            </div>
        </div>
